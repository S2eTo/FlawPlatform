...
from users.models import EmailToken, User
...
class GetImagesValidation(forms.Form):
    ...
    complexity = forms.IntegerField(label="难度", min_value=0, required=True, error_messages={
        'invalid': "难度参数是整数哟.",
    })
...
class RegisterEmailValidation(forms.Form):
    error_messages = {
        'unique': "该邮箱已注册！",
    }
...
class ResetPasswordEmailValidation(forms.Form):
    error_messages = {
        'unique': "该邮箱未注册！",
    }
